...
import Engine.Types exposing (Vec2, Bounds2)

type alias Vec2i = Vec2 Int
type alias Vec2f = Vec2 Float
...
rand2i ((lx, ly), (hx, hy)) = vec2 (rnd lx hx) (rnd ly hy)

withDefault : Vec2 a -> Maybe (Vec2 a) -> Vec2 a
withDefault p mby = Maybe.withDefault p mby

collides2 : Vec2 a -> Vec2 a -> Bool
collides2 (ax, ay) (bx, by) = ax == bx && ay == by
